class TelegramLoginController < AccountController
  ...
  def check_auth
    ...
    auth = RedmineBots::Telegram::Bot::Authenticate.(user, login_params, context: params[:context])
  ...
  def send_sign_in_link
    ...
    RedmineBots::Telegram::Bot::SendSignInLink.(user, context: params[:context])
  end
